...
public class Keyword extends BaseClass {
	...
	public static void CLICK(String xpathName) throws InterruptedException, IOException {
	...
	public static Boolean EXISTS(String xpathName) throws InterruptedException, IOException {
	...
	public static void EXISTS_in30Secs(String xpathName) throws InterruptedException, IOException {
	...
	public static void EXISTS_in30Secs_CLICK(String xpathName) throws InterruptedException, IOException {
	...
	public static void IF_EXISTS_CLICK(String xpathName) throws InterruptedException, IOException {
	...
	public static void INPUT(String xpathName, String input)throws IOException, InterruptedException {
	...
	public static void ON_ERROR_LOGOUT() {
	...
	public static void WAIT(int timeInMillisec) throws InterruptedException {
